			# grep OG0025470 Atwista_Telonemids_interpro.gff3 > OG0025470_gff3_output.txt; grep -v MobiDBLite OG0025470_gff3_output.txt > OG0025470_gff3_output_minusMobi.txt;
			# grep -e match\$[0-9]*_[0-9]*_[0-9]* -e \>.*_OG0025470.fal -o OG0025470_gff3_output_minusMobi.txt > match_ids.txt
...
align_file = open(taxa + "_to_align.fasta", "w")
...
cline = MuscleCommandline(input="Atwista_Telonemids_to_align.fasta", out="align_output.txt", clw=True)
cline()
